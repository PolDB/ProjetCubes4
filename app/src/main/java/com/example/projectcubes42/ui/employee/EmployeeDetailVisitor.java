...
//il s'agit de l'activité qui affiche les détail d'un utilisateur
public class EmployeeDetailVisitor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_details_visitor);
        ...
        nameDetail = findViewById(R.id.nameDetailVisitor);
        firstnameDetail = findViewById(R.id.firstnameDetailVisitor);
        phoneDetail = findViewById(R.id.phoneDetailVisitor);
        emailDetail = findViewById(R.id.emailDetailVisitor);

        spinnerService = findViewById(R.id.employeeDepartmentDetailVisitor);
        spinnerSite = findViewById(R.id.employeeSiteDetailVisitor);
    ...
    private void observeViewModel() {
        ...
        viewModel.getToastMessage().observe(this, message -> {
            if (message != null && !message.isEmpty()) {
                Toast.makeText(EmployeeDetailVisitor.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    }
