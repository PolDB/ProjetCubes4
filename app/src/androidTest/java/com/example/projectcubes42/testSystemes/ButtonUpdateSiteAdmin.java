...
public class ButtonUpdateSiteAdmin {
    @Rule
    ...
    public void testDrawerLayoutAcess() {
        ...
        onView(withId(R.id.site_button_edit)).perform(click());
        onView(withId(R.id.siteDetail)).perform(clearText());
        onView(withId(R.id.siteDetail)).perform(typeText("Poitiers"));
        onView(withId(R.id.site_save_update)).perform(click());
